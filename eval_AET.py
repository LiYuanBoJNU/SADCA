...
def retrieval_eval(model, ref_model, t_models, t_ref_models, t_test_transforms, data_loader, tokenizer, t_tokenizers, device, args,config):
    ...
    with torch.no_grad():
        all_texts_input = tokenizer(all_texts, padding='max_length', truncation=True,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_file_path', default='./result_SA-AET.txt')
    parser.add_argument('--save_advimg_path', default='./flickr30k_adv/SA-AET_CLIP_CNN/')
    parser.add_argument('--save_advimg_caption_path', default='./flickr30k_adv/SA-AET_CLIP_CNN.json')
